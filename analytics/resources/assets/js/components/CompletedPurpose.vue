            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="well" v-if="info.petsafe && info.petsafe.Keys && info.petsafe.CompletedPurpose">
                      ...
                      :values="[info.petsafe.Total, info.petsafe.CompletedPurpose]"
                      :colors="['#D3C4BE', '#EBCFC4']"
                      :names="['Total', 'Completed purpose']"></bar-graph>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-yellow">
                ...
                <div class="panel-body">
                    ...
                    <div class="well" v-if="info.sportdog && info.sportdog.Keys && info.sportdog.CompletedPurpose">
                      ...
                      :values="[info.sportdog.Total, info.sportdog.CompletedPurpose]"
